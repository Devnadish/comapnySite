...
export function getLocale(request) {
  ...
  console.log("Preferred Languages:", languages); // Log the preferred languages
  console.log("Supported Locales:", locales); // Log the supported locales
  ...
  console.log("Final Locale:", finalLocale); // Log the final locale
